...
public class CategoryController {
    ...
    @DeleteMapping("/delete-auction-category/{categoryId}/{auctionId}")
    public String deleteCategory(@PathVariable String categoryId,@PathVariable String auctionId){
        return categoryService.delete(categoryId,auctionId);
    }
