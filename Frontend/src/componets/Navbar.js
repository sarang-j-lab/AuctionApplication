            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <nav className="flex items-center justify-between h-16 lg:h-20 bg-white ">
                    ...
                    <div className="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10">
                        ...
                        <p title="" className="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">Features</p>
                ...
                {block && <nav className="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
                    <div className="flow-root ">
                        <ul className="flex flex-col px-6 -my-2 space-y-1">
                            <li  className="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">Features</li>
