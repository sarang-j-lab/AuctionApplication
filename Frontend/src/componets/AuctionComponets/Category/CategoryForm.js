...
const CategoryForm = () => {
    ...
    const handleSubmits = async (event) => {
        ...
        if (categoryData.maxPlayerPerTeam < categoryData.minPlayerPerTeam) {
            ...
            <form className="max-w-lg mx-auto" id={categoryData.categoryId} onSubmit={handleSubmits}>
                ...
                <div className='flex gap-2'>
                    <div className="mb-5">
                        ...
                        <input onChange={(e) => { setCategoryData({ ...categoryData, "maxPlayerPerTeam": e.target.value }) }} value={categoryData.maxPlayerPerTeam} type="number" id="maxPlayerPerTeam" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder='Ex. 4' required />
                    </div>
                  {!isEditForm &&  <div className="mb-5">
                        ...
                        <input onChange={(e) => { setCategoryData({ ...categoryData, "minPlayerPerTeam": e.target.value }) }} value={categoryData.minPlayerPerTeam} type="number" id="minPlayerPerTeam" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder='Ex. 2' required />
                    </div>}
                </div>
                {!isEditForm && <div className="mb-5">
                    <label htmlFor="baseBid" className="block mb-2 text-sm font-medium text-gray-900 dark:gray-white">Base bid</label>
                    <input onChange={(e) => { setCategoryData({ ...categoryData, "baseBid": e.target.value }) }} value={categoryData.baseBid} type="number" id="baseBid" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder='Ex. 2,500' required />
                </div>}
                <div className="mb-5">
                    <label htmlFor="increment" className="block mb-2 text-sm font-medium text-gray-900 dark:gray-white">Bid increaseBy</label>
                    <input onChange={(e) => { setCategoryData({ ...categoryData, "increment": e.target.value }) }} value={categoryData.increment} type="number" id="increment" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder='Ex. 1000' required />
                </div>
